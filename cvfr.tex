...
\begin{enumerate}
  \setcounter{enumi}{\value{listCounter}}
  \item Tomatograph 2021,  Adaptive Method for Soft Body Simulations.\stepcounter{listCounter}
  \item Séminaire Université Laval 2022, Infographie et Animation Physique : Solidification de Matériaux Viscoélatisques.\stepcounter{listCounter}
  \item GraphQuOn 2023, Strain-based Multi-Layer solver for XPBD.\stepcounter{listCounter}
\end{enumerate}
