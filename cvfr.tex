...
\begin{enumerate}
  ...
  \item Alexandre Mercier-Aubin, Ludwig Dumetz, Jonathan Gaudreault, and Claude-Guy Quimper. The Confidence Constraint: A Step Towards Stochastic CP Solvers. In Proceedings of the 26th International Conference on Principles and Practice of Constraint Programming (CP), pages 759-773, 2020. \stepcounter{listCounter}
 ...
 \item Alexandre Mercier-Aubin,  Alexandre Winter,  David I. W. Levin, and Paul G. Kry. Adaptive Rigidification of Elastic Solids. In ACM Transactions on Graphics (TOG), volume 41, issue 4, article 71, 2022.  \stepcounter{listCounter}

 \item Alexandre Mercier-Aubin and Paul G. Kry. Adaptive Rigidification of Discrete Shells. Proceedings of the ACM on Computer Graphics and Interactive Techniques (PACMCGIT), volume 6, issue 3, 2023. \stepcounter{listCounter}

\item Alexandre Mercier-Aubin and Paul G. Kry. A Multi-layer Solver for XPBD. To appear in Proceedings of the Computer Graphics Forum (CGF), volume 43, issue 5, 2024.\stepcounter{listCounter}
\end{enumerate}
...
Conference on Principles and Practice of Constraint Programming (CP 2019). Stamford, CT, U.S. \stepcounter{listCounter}
...
\begin{enumerate}
  \setcounter{enumi}{\value{listCounter}}
  \item Alexandre Mercier-Aubin, Ordonnancement de tâches sous contraintes sur des métiers à tisser, Université Laval, 2020. \stepcounter{listCounter}
\end{enumerate}

\subsection{Affiches}
\begin{enumerate}
  \setcounter{enumi}{\value{listCounter}}
  \item Alexandre Mercier-Aubin, Adaptive Rigidification of Elastic Solids Prototype, Graphics Interface (GI), 2022. \stepcounter{listCounter}
  \item Alexandre Mercier-Aubin, Adaptive Rigidification of Elastic Solids Prototype, REPARTI, 2022. \stepcounter{listCounter}
\end{enumerate}

\subsection{Selection d'exposés}
\begin{enumerate}
  \setcounter{enumi}{\value{listCounter}}
  \item Tomatograph,  Adaptive Method for Soft Body Simulations, 2021.\stepcounter{listCounter}
  \item Special Interest Group on Computer Graphics and Interactive Techniques (SIGGRAPH), Adaptive Rigidification of Elastic Solids, 2022. \stepcounter{listCounter}
  \item Séminaire Université Laval, Infographie et Animation Physique : Solidification de Matériaux Viscoélatisques, 2022.\stepcounter{listCounter}
  \item Symposium on Computer Animation (SCA), Adaptive Rigidification of Discrete Shells, 2023. \stepcounter{listCounter}
  \item Quebec-Ontario pre-SIGGRAPH workshop (GraphQuOn), Strain-based Multi-Layer solver for XPBD, 2023.\stepcounter{listCounter}
  \item Symposium on Computer Animation (SCA), A Multi-layer Solver for XPBD, 2024. \stepcounter{listCounter}
\end{enumerate}
