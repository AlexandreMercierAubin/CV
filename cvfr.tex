...
Je suis candidat au doctorat avec l'intention de déposer ma thèse en octobre 2024. Mes domaines d'études incluent l'infographie, la simulation physique, l'optimisation et la conception d'algorithmes, ainsi que la programmation par contraintes. Mon domaine de recherche me permet de choisir des sujets abstraits tout en visualisant les résultats de manière interactive. Mon travail en infographie combine un certain niveau artistique, parfois même créatif, avec la volonté de faire progresser le domaine. Mes résultats ont mené à des applications tant dans les simulateurs de chirurgie que dans des contextes plus ludiques comme les films et les jeux vidéo.
...
\item \textbf{Alexandre Mercier-Aubin} and Paul G. Kry. A Multi-layer Solver for XPBD. To appear in Proceedings of the Computer Graphics Forum (CGF), volume 43, issue 5, 2024.\stepcounter{listCounter}
\end{enumerate}
