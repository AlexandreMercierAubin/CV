...
Graduate student at McGill University in computer science. My fields of study are constraint programming, computer graphics, and algorithm design.
...
\tabbedblock{
\bf{2020-2024} \> PhD in Computer Science - \href{https://www.ulaval.ca/en/}{McGill University} \\[5pt]
\>\+
\textit{In progress} \> \\
}
...
{Attend office hours, grade exams, and present guest lectures.}
...
\skillgroup{FRQNT 2nd and 3rd cycle scholarship}
{
 25 000\$ \textit{per year, up to 3 years} \\
}

\skillgroup{NSERC Alliance}
{
 15 000 \\
}
...
All of my work is listed on my website \href{alexandremercieraubin.com/Work}{alexandremercieraubin.com/Work}
